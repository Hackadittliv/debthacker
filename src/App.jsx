        ...
        {sent ? (
          ...
          <div>
            ...
            <button
              ...
              disabled={loading}
              style={{ width: '100%', padding: 12, background: C.bgElevated, border: `1px solid ${C.borderStrong}`, borderRadius: 10, color: C.textPrimary, fontSize: 14, fontWeight: 600, cursor: loading ? 'wait' : 'pointer', marginBottom: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 10, boxSizing: 'border-box' }}
            >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 12 }}>
              ...
              <span style={{ fontSize: 12, color: C.textMuted }}>eller via e-post</span>
              <div style={{ flex: 1, height: 1, background: C.border }} />
            </div>
